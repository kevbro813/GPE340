...
public class PlayerPawn : Base_Pawn
{
    ...
    public override void EquipWeapon(GameObject weap)
    {
        ...
        equippedWeapon.GetComponent<Weapon>().isPlayerWeapon = true; // Indicates the current pawn is the player
    ...
    public override void UnequipWeapon()
    {
        ...
        {
            equippedWeapon.GetComponent<Weapon>().isPlayerWeapon = false; // Indicate the pawn does not control the weapon
